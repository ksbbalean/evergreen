...
erpnext.selling.ShippingDocumentController = erpnext.selling.SellingController.extend({
	...
	// 								label: __('Shipping Document Item'), hidden:1}
	// 						],
	// 						data: r.message,
	// 						get_data: function() {
	// 							return r.message
	...
	// 		method: "evergreen.evergreen.doctype.shipping_document.shipping_document.make_material_request",
	// 		frm: this.frm
	// 	})
	// },
	...
	make_delivery_note: function() {
		frappe.model.open_mapped_doc({
			method: "evergreen.evergreen.doctype.shipping_document.shipping_document.make_delivery_note",
			frm: me.frm
		})
	},
	...
	// 	frappe.model.open_mapped_doc({
	// 		method: "evergreen.evergreen.doctype.shipping_document.shipping_document.make_maintenance_schedule",
	// 		frm: this.frm
	// 	})
	// },
	...
	// 	frappe.model.open_mapped_doc({
	// 		method: "evergreen.evergreen.doctype.shipping_document.shipping_document.make_project",
	// 		frm: this.frm
	// 	})
	// },
	...
	// 	frappe.model.open_mapped_doc({
	// 		method: "evergreen.evergreen.doctype.shipping_document.shipping_document.make_maintenance_visit",
	// 		frm: this.frm
	// 	})
	// },
	...
	// 				"get_query": function () {
	// 					return {
	// 						query:"evergreen.evergreen.doctype.shipping_document.shipping_document.get_supplier",
	...
	// 		return frappe.call({
	// 			type: "GET",
	// 			method: "evergreen.evergreen.doctype.shipping_document.shipping_document.make_purchase_order_for_drop_shipment",
	// 			args: {
	...
	update_status: function(label, status){
		...
		frappe.call({
			method: "evergreen.evergreen.doctype.shipping_document.shipping_document.update_status",
...
$.extend(cur_frm.cscript, new erpnext.selling.ShippingDocumentController({frm: cur_frm}));

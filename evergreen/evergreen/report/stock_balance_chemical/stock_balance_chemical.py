...
def execute(filters=None):
	...
	for row in data:
		...
		if has_batch_no:
			row['batch_wise'] = """<button style='margin-left:5px;border:none;color: #fff; background-color: #5e64ff; padding: 3px 5px;border-radius: 5px;'
			...
			""".format(item_code=item_code, filter_company=filter_company, from_date=from_date, to_date=to_date)
		...
		row['stock_ledger'] = """<button style='margin-left:5px;border:none;color: #fff; background-color: #5e64ff; padding: 3px 5px;border-radius: 5px;'
			...
			""".format(item_code=item_code, filter_company=filter_company, from_date_fiscal=from_date_fiscal, to_date=to_date)
